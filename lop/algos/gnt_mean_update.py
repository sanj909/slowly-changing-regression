...
class GnT(object):
    ...
    def update_utility(self, layer_idx=0, features=None, next_features=None, norms=None):
        with torch.no_grad():
            ...
            elif self.util_type == 'mean_update':
                new_util = -norms[layer_idx] / input_wight_mag
    ...
    def test_features(self, features, norms):
        """
        Args:
        ...
        for i in range(self.num_hidden_layers):
            ...
            """
            self.update_utility(layer_idx=i, features=features[i], norms=norms)
            """
    ...
    def gen_and_test(self, features, norms):
        """
