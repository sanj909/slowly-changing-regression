...
class GnT(object):
    ...
    def update_utility(self, layer_idx=0, features=None, next_features=None, all_ablation_losses=None):
        with torch.no_grad():
            ...
            elif self.util_type == 'natural_importance':
                new_util = -all_ablation_losses[layer_idx] / input_wight_mag
            elif self.util_type == 'sparse_natural_importance':
                new_util = -all_ablation_losses[layer_idx] / input_wight_mag
            elif self.util_type == 'natimp_taylor':
                new_util = -all_ablation_losses[layer_idx] / input_wight_mag
    ...
    def test_features(self, features, all_ablation_losses):
        """
        Args:
        ...
        for i in range(self.num_hidden_layers):
            ...
            """
            self.update_utility(layer_idx=i, features=features[i], all_ablation_losses=all_ablation_losses)
            """
    ...
    def gen_and_test(self, features, all_ablation_losses):
        """
